...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        // back icon
        ImageIcon i1 = new ImageIcon("src/icons/3.png");
        ...
        // profile icon
        ImageIcon i4 = new ImageIcon("src/icons/2.png");
        ...
        // video icon
        ImageIcon i7 = new ImageIcon("src/icons/video.png");
        ...
        // phone icon
        ImageIcon i10 = new ImageIcon("src/icons/phone.png");
        ...
        // menu icon
        ImageIcon i13 = new ImageIcon("src/icons/3icon.png");
